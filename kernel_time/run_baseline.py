#!/usr/bin/env python3
"""
Run baseline kernel time experiments for all repositories.
Results are saved to kernel_time/results/baseline/
"""
...
class KernelTimeBaselineRunner:
    def __init__(self):
    ...
    def run_all_tests(self, repositories, whitelists=None):
        """Run all tests with baseline kernel time configurations."""
        ...
        print(f"\nRunning tests with {len(ENV_CONFIGS)} baseline kernel time configurations")
        print("=" * 60)
    ...
    def print_summary(self):
        ...
        print("\n" + "=" * 60)
        print("KERNEL TIME BASELINE TEST SUMMARY")
        print("=" * 60)
...
def main():
    ...
    print("=" * 60)
    print("Running Baseline Kernel Time Experiments")
    print("=" * 60)
    print()
    ...
    print("\n" + "=" * 60)
    print("Baseline kernel time experiments completed!")
